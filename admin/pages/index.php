...
<head>
    <title>Login | BeastX Fitness</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
                    ...
                    <div class="card sm:my-12  w-full shadow-none">
                        <div class="card-body !p-10">
                            ...
                            if (isset($_POST['btn_login'])) {
                                ...
                                $pass = $_POST['txtpass'];
                                $q = mysqli_query($conn, "select * from admin_master where email='$email' and pass='$pass'");
                            ...
                            <form method="post">
                                <div class="mb-3">
                                    <input type="email" class="form-control" name="txtemail" id="floatingInput" placeholder="Email Address" name="txtemail" />
                                </div>
                                <div class="mb-4">
                                    <input type="password" class="form-control" name="txtpass" id="floatingInput1" placeholder="Password" name="txtpass" />
                                </div>
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <input type="submit" class="btn btn-primary mx-auto shadow-2xl" value="Submit" name="btn_login">
                                </div>
